...
const DialogOverlay = <T extends ValidComponent = "div">(
  ...
  return (
    <DialogPrimitive.Overlay
      class={cn(
        "data-[closed]:fade-out-0 data-[expanded]:fade-in-0 fixed inset-0 z-50 bg-black/80 data-[closed]:animate-fadeOut data-[expanded]:animate-fadeIn",
        props.class
      )}
      {...rest}
    />
...
const DialogContent = <T extends ValidComponent = "div">(
  ...
  const defaultProps = mergeProps({ showClose: true }, props)
  ...
  return (
    <DialogPortal>
      ...
      >
        {props.children}
        <Show when={defaultProps.showClose}>
...
export function DialogComp(
  ...
  return (
    <Dialog {...rest}>
      ...
      <DialogContent {...props.contentProps}>{local.children}</DialogContent>
    </Dialog>
  )
}
