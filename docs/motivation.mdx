---
title: Motivation
description: Why gittydocs exists.
---
...
![gittydocs jsoncmdx](/static/gittydocs_jsoncmdx.jpg)
...
- **You have a Rust/Python project** and can't be bothered with JS frameworks and just want readable, searchable docs without the hassle
